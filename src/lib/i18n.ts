...
const en: Dict = {
  ...
  "champ.choose": "Choose…",
  "champ.saved": "Saved ✓",
  "champ.choosebig": "🏆 Pick your World Cup champion",
  "champ.choosesub": "Who lifts the trophy? Worth +15 pts if you're right. You can change it twice — choose wisely.",
  "champ.yourchamp": "Your champion",
  "champ.change": "Change pick",
  "champ.changesleft": "{n} change(s) left",
  "champ.nochanges": "🔒 Locked in — no changes left.",
  "champ.cancel": "Cancel",
  "champ.react.POR": "🐐 You're a GOAT for picking this.",
...
const fr: Dict = {
  ...
  "champ.choosebig": "🏆 Choisissez votre champion",
  "champ.choosesub": "Qui soulève le trophée ? +15 pts si vous avez raison. Vous pouvez le changer deux fois — choisissez bien.",
  "champ.yourchamp": "Votre champion",
  "champ.change": "Changer",
  "champ.changesleft": "{n} changement(s) restant(s)",
  "champ.nochanges": "🔒 Verrouillé — plus de changement possible.",
  "champ.cancel": "Annuler",
  "champ.react.POR": "🐐 T'es un GOAT d'avoir choisi ça.",
